...
const Anonymous = () => {
    ...
    return (
        <>
            <div className=' flex justify-center items-center gap-2 h-24 w-72 sm:w-full bg-emerald-400 dark:bg-slate-800 rounded-3xl'>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmitt)} className='space-y-4 w-full'>
                        ...
                        <div className='flex gap-4'>
                            <Button type="reset" onClick={() => form.reset()} className='rounded-3xl bg-emerald-400 dark:bg-slate-800 hover:bg-emerald-400 dark:text-white hover:text-white  w-full font-semibold hover:-translate-y-[2px] hover:shadow-md transition-all duration-300'>Cancel</Button>
