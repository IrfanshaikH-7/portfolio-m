                            ...
                            <div className="mt-2 text-slate-600 dark:text-white/80">
                                ...
                                <section className="flex flex-col">
                                    <div className="flex flex-col">
                                        <h4 className="font-bold text-lg">- Full stack developer at Self, Hyderabad.</h4>
                                        <ul className="list-disc ml-6" >
                                            <p className="text-[9px] text-slate-600 dark:text-slate-400 pb-px">June 2022 - Present</p>
                                            <li className=" text-slate-600 dark:text-white/80 text-xs lg:text-sm">Developed various full-stack web apps on my own going through documentations.</li>
                                            <li className=" text-slate-600 dark:text-white/80 text-xs lg:text-sm">These projects demonstrate my skills and experience in software development, which are essential for the any role in software development.</li>
                                            <li className=" text-slate-600 dark:text-white/80 text-xs lg:text-sm">Experienced various web technologies and frameworks etc.</li>
                                        </ul>
                                    </div>

                                    <div className="flex flex-col">
                                        <h4 className="font-bold text-lg">- Opensource</h4>
                                        <ul className="list-disc ml-6" >
                                            <p className="text-[9px] text-slate-600 dark:text-slate-400 pb-px">March 2023 - Present</p>
                                            <li className=" text-slate-600 dark:text-white/80 text-xs lg:text-sm">Contributing to Opensource helped me improve my skills set.</li>
                                            <li className=" text-slate-600 dark:text-white/80 text-xs lg:text-sm">Learned a lot from other developer.</li>
                                            <li className=" text-slate-600 dark:text-white/80 text-xs lg:text-sm">Lived a real-world work like experience.</li>
                                        </ul>
                                    </div>
                                </section>
