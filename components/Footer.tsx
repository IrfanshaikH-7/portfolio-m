            ...
            <div className=' flex-1 gap-12 flex flex-row w-full h-full justify-center items-start  py-12'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex gap-4 '>
                         <Link href='http://github.com/IrfanshaikH-7' target='_blank' className='h-12 w-12 border-2 flex hover:bg-black dark:hover:bg-white group justify-center items-center transition-all duration-300 text-slate-700 dark:text-slate-500'><Github className='text-slate-600 fill-slate-600 dark:text-slate-500 dark:fill-slate-500 hover:dark:text-black hover:dark:fill-black hover:text-white hover:fill-white' /></Link>
                        <Link href='https://www.linkedin.com/in/IrfanshaikH-n7/' target='_blank' className='h-12 w-12 border-2 hover:bg-black dark:hover:bg-white group flex justify-center items-center transition-all duration-300 text-slate-700 dark:text-slate-500'><Linkedin className='text-slate-600 fill-slate-600 dark:text-slate-500 dark:fill-slate-500 hover:dark:text-black hover:dark:fill-black hover:text-white hover:fill-white' /></Link>
                        <Link href='https://www.linkedin.com/in/IrfanshaikH-n7/' target='_blank' className='h-12 w-12 border-2 hover:bg-black dark:hover:bg-white group flex justify-center items-center transition-all duration-300 text-slate-700 dark:text-slate-500'><Twitter className='text-slate-600 fill-slate-600 dark:text-slate-500 dark:fill-slate-500 hover:dark:text-black hover:dark:fill-black hover:text-white hover:fill-white' /></Link>
