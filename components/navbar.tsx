  ...
  return (
    ...
    <>
      ...
      <div className="flex items-center ">
        <DropdownMenu >
          <DropdownMenuTrigger className="flex justify-center items-center"><span className="uppercase text-slate-600 dark:text-white">Menu</span><Text className=" h-5 w-5  text-slate-600 dark:text-white" /></DropdownMenuTrigger>
