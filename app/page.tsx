  ...
  return (
    <>
        ...
        <main className='h-full w-full flex justify-center'>
          ...
          <section className='h-full w-full mx-auto flex-col justify-center items-center z-10 bg-gradient-to-t from-emerald-400 from-10% via-sky-500 via-60% to-indigo-500 to-90% '>
            ...
            <section className='bg-gradient-to-t from-emerald-400 via-emerald-400 h-60 -mt-8 rounded-b-[80px] pointer-events-none md:px-32 py-4 '>
              <motion.div className='h-full w-full flex-col justify-center items-center bg-white rounded-[80px] overflow-hidden py-2'
                initial={{ opacity: 0 }}
      ...
      <div className='flex flex-col fixed top-0 h-screen w-full  -z-50 '>
        ...
        <div className='flex-1 w-full flex justify-self-end it justify-center items-center relative -z-20'>
